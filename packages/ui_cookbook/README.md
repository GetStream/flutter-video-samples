# Video UI Cookbook
This project demonstrates different customization and development options which can be applied to projects using Stream's [Video API](https://getstream.io/video). 

## Current projects:
- Custom Participant List: Learn how `CallState` can be used to render custom call components like a real-time call participant list displaying the user's avatar and mircophone state. 
...
cd flutter-video-samples/packages/ui_cookbook
```
