import 'package:audio_room_with_chat/env/env.dart';
import 'package:audio_room_with_chat/sample_user.dart';
import 'package:audio_room_with_chat/screens/audio_rooms_screen.dart';
import 'package:audio_room_with_chat/user_mapper.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Choose your user')),
      body: SafeArea(
  ...
  Future<void> _connectChatUser(BuildContext context, SampleUser user) async {
    ...
    await chatClient.connectUser(user.toChatUser(), user.token);
  }
